...
<!--
     XDK changes as compared to the original W3C XQUF 1.0 stylesheet
     to make it compatible with XQuery 3.0:
     1. to xqx:functionDecl redefinition is copied from XQUF 3.0 draft
-->
